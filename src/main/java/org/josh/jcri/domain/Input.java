...
0).
        ...
        @Override public StringBuilder toJson(StringBuilder strBuilder) {
            ...
            if (unmodifiedText != null) strBuilder.append(",\"unmodifiedText\":").append('"').append(unmodifiedText).append('"');
            if (keyIdentifier != null) strBuilder.append(",\"keyIdentifier\":").append('"').append(keyIdentifier).append('"');
            if (code != null) strBuilder.append(",\"code\":").append('"').append(code).append('"');
            if (key != null) strBuilder.append(",\"key\":").append('"').append(key).append('"');
...
for the preferred input type).
        ...
        @Override public StringBuilder toJson(StringBuilder strBuilder) {
            ...
            if (interactionMarkerName != null) strBuilder.append(",\"interactionMarkerName\":").append('"').append(interactionMarkerName).append('"');
            strBuilder.append('}');
            return strBuilder;
        }
