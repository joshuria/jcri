...
@ParametersAreNonnullByDefault public class SystemInfo extends DomainBase {
    ...
    @ParametersAreNonnullByDefault public static class GPUDevice implements CommonDomainType {
        ...
        @Override public StringBuilder toJson(StringBuilder strBuilder) {
            ...
            strBuilder.append(",\"vendorString\":").append('"').append(vendorString).append('"');
            strBuilder.append(",\"deviceString\":").append('"').append(deviceString).append('"');
            strBuilder.append('}');
            return strBuilder;
        }
        public GPUDevice() {}
    ...
    @ParametersAreNonnullByDefault public static class GPUInfo implements CommonDomainType {
        ...
        @Override public StringBuilder toJson(StringBuilder strBuilder) {
            ...
            strBuilder.append('"').append(driverBugWorkarounds.get(0)).append('"');
            for (int i = 1; i < driverBugWorkarounds.size(); ++i)
                strBuilder.append(",\"").append(driverBugWorkarounds.get(i)).append('"');
            strBuilder.append(']');
            strBuilder.append('}');
            return strBuilder;
        }
...
supported.*/
        ...
        @Override public StringBuilder toJson(StringBuilder strBuilder) {
            ...
            strBuilder.append(",\"modelName\":").append('"').append(modelName).append('"');
            strBuilder.append(",\"modelVersion\":").append('"').append(modelVersion).append('"');
            strBuilder.append(",\"commandLine\":").append('"').append(commandLine).append('"');
            strBuilder.append('}');
            return strBuilder;
        }
